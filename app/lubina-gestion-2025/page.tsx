...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: FiBook,
      color: "bg-purple-500",
      href: "/lubina-gestion-2025/gallery",
    },
  ];
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="space-y-3">
            <Link href="/lubina-gestion-2025/menu">
            ...
            <Link href="/lubina-gestion-2025/hero">
            ...
            <Link href="/lubina-gestion-2025/gallery">
